...
previously stored element located at readIx, readIx = readIx + 1. When readIx is
at the end of the buffer, it jumps to the start. These might be imagined like
two frogs jumping in circus, the first frog is producer, and the second one is
consumer.
